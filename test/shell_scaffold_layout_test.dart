...
void main() {
  testWidgets('TempoTabBar anchored at bottom via Stack Positioned', (
    tester,
  ) async {
    ...
    expect(
      dy,
      greaterThan(screenH * 0.5),
      reason: 'tab labels should be near bottom',
    );
  });

  testWidgets(
    'TempoTabBar inside AnimatedSlide without outer Positioned sits at top',
    (tester) async {
      await pumpTabBarStack(
        tester,
        const AnimatedSlide(
